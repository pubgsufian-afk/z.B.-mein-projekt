...
const afterEnd = new Date('2026-08-07T20:15:00.000Z')
...
function repositoryWithSite() {
  ...
  return {
    ...
    async findObject() { return { id: 'site-1', latitude: 52.375, longitude: 9.732, radiusMeters: 100 } },
...
await outsideEndService.record(actor, {
  action: 'clock-in', clientEventId: 'outside-end-start', clientOccurredAt: '2026-08-07T19:00:00.000Z', scheduleId: 'shift-1', objectId: 'site-1', location: insideLocation,
})
const outsideEnd = await outsideEndService.record(actor, {
  action: 'clock-out', clientEventId: 'outside-end-finish', clientOccurredAt: '2026-08-07T20:15:00.000Z', scheduleId: 'shift-1', objectId: 'site-1', location: outsideLocation,
})
...
await noLocationService.record(actor, {
  action: 'clock-in', clientEventId: 'no-location-start', clientOccurredAt: '2026-08-07T19:00:00.000Z', scheduleId: 'shift-1', objectId: 'site-1', location: insideLocation,
})
const noLocationEnd = await noLocationService.record(actor, {
  action: 'clock-out', clientEventId: 'no-location-finish', clientOccurredAt: '2026-08-07T20:16:00.000Z', scheduleId: 'shift-1', objectId: 'site-1', location: null,
})
