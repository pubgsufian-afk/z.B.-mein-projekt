...
assert.match(augustCorrection, /Amin Khalaf Kije/)
assert.match(augustCorrection, /target_pause_minutes\s*=\s*30/)
assert.match(augustCorrection, /Almusa/)
assert.match(augustCorrection, /Amjad/)
assert.match(augustCorrection, /Kanee/)
assert.match(augustCorrection, /target_pause_minutes\s*=\s*60/)
assert.match(augustCorrection, /Mohamad/)
assert.match(augustCorrection, /Mohamed Ahmed warsame/)
