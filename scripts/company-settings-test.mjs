...
assert.match(helper, /address/)
assert.match(helper, /logoUrl/)
assert.match(helper, /portal-company-settings/)
assert.match(helper, /\+49 1573 3967124/)
assert.match(helper, /info@habun-security\.de/)
assert.match(helper, /Ringstraße 7, 30457 Hannover/)
