...
assert.match(schedule, /commandContext\.reason/)
assert.match(attendance, /commandContext\.reason/)
assert.match(schedule, /new Set\(\['published', 'duplicate', 'already_satisfied'\]\)/)
