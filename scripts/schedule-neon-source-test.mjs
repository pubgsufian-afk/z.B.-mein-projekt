...
assert.match(repository, /HABUN_SCHEDULE_DATABASE_URL/)
assert.match(repository, /getDatabase\(\{ connectionString \}\)/)
assert.doesNotMatch(repository, /const database = getDatabase\(\)/)
