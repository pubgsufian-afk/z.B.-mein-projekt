...
assert.ok(repositorySource.includes("status = 'active'"))
assert.ok(repositorySource.includes('lower(btrim(employee_name)) = lower(btrim($2))'))
assert.ok(repositorySource.includes('COUNT(*) = 1'))
