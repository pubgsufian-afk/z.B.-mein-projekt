...
assert.deepEqual(parseScheduleCommand(JSON.stringify(valid[2]), now).command?.approvedUnregisteredNames, ['Guest Example'])
...
const invalid = [
  ...
  JSON.stringify({ ...base, commandId: 'x', action: 'publish-shifts', allowUnregistered: true, shifts: [{ employeeName: 'Test Person', date: '2026-08-11', start: '06:00', end: '14:00', workArea: 'ZuKo' }] }),
