...
assert.match(workflow, /SCHEDULE_ENVELOPE_REF:/)
...
assert.match(relay, /SCHEDULE_ENVELOPE_REF/)
...
assert.match(relay, /api\.github\.com\/repos\/\$\{repository\}\/contents\/ops\/schedule-command\.envelope\.json/)
assert.match(relay, /https:\/\/habun-mitarbeiterportal\.netlify\.app\/api\/schedule-oidc-trigger/)
assert.doesNotMatch(relay, /SCHEDULE_ENVELOPE_COMMENT/)
