...
assert.match(neonSchedule, /listEmployeeScheduleShifts/)
assert.match(neonSchedule, /employeeUserId:\s*current\.userId/)
assert.match(neonSchedule, /employeeName,\s*publishedOnly:\s*true/)
