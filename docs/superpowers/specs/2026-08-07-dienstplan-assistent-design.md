...
Die Implementierung erfolgt zunächst auf dem separaten GitHub-Branch `feature/dienstplan-assistent-current`. Keine Produktionsveröffentlichung ohne gesonderte Freigabe nach Prüfung.
