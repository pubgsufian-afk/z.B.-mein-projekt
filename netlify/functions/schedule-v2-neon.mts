...
async function ensureLegacyScheduleMigrated() {
  ...
  await markScheduleMigration(LEGACY_MIGRATION_KEY, { migratedShifts: migrated, legacyShiftCount: legacyShifts.length })
